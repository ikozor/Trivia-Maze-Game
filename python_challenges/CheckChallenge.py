...
if challenge == "dec_to_bin":
    from Challenge import dec_to_bin
    print(dec_to_bin(0), end=" ")
    print(dec_to_bin(4), end=" ")
    print(dec_to_bin(10), end=" ")
    print(dec_to_bin(31))
elif challenge == "remove_nums":
    from Challenge import remove_nums
    print(remove_nums("H3e55llo099 3W345orl324d"))
    ...
    from Challenge import X_is_O
    print(X_is_O("XXXOOOXOXO"), end=" ")
    print(X_is_O("XOX"))
elif challenge == "is_palindrome":
    from Challenge import is_palindrome
    print(is_palindrome("123456789","987654321"),end=" ")
    print(is_palindrome("12341234,1234431"))
elif challenge == "calculator":
    from Challenge import calculator
    print(calculator(4, 8, "+"), end=" ")
    print(calculator(8, 16, "-"), end=" ")
    print(calculator(8, 8, "*"), end=" ")
    print(calculator(18, 18, "/"))
elif challenge == "sort_list":
    from Challenge import sort_list
    print(sort_list([2, 1, 4, 3], "asc"), end=" ")
    print(sort_list([4, 2, 6, 8], "desc"), end=" ")
    print(sort_list([5, 5, 3, 7], "none"))
"""
